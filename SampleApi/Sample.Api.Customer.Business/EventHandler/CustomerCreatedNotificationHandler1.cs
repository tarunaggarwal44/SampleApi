...
namespace Sample.Api.Customer.Business.EventHandler
{
    ...
    public class CustomerCreatedNotificationHandler1 : INotificationHandler<CustomerCreatedDomainEvent>
    {

        // In a REAL app you might want to use the Outbox pattern and a command/queue here...
        public CustomerCreatedNotificationHandler1()
        {
        ...
        {
            Log.Debug("CustomerCreatedNotificationHandler1 started" + DateTime.UtcNow.ToString());
            ...
            Log.Debug("CustomerCreatedNotificationHandler1 ended" + DateTime.UtcNow.ToString());
        }
